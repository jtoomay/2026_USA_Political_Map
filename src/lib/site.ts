...
export const SITE_NAME = 'Toomay'
export const SITE_TITLE_DEFAULT = 'Toomay — built with Next.js'
export const SITE_DESCRIPTION =
  'A Next.js starter tuned for SEO from the ground up: server-rendered content, full metadata, structured data, and a sitemap — ready to build a SaaS product on.'
